function sidebar() {
  return `<h3> ##Refine By</h3><br />
    <div>
      ...
      <p style="font-size: 16px"><a href="Bestsellers.html" style="text-decoration: none;">Bestsellers</a></p>
      <select id="" style="border:none; font-size: 15px;">
      <a href="Skin_care.html" style="text-decoration: none;"><option value="" > Skin Care</option></a>
